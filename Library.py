...
class maincode:
    ...
    def cur(self):
        ...
        self.lb1_hr = Label(self.fm3, text='12', font=('times new roman', 20, 'bold'), bg='black', fg='white')
        self.lb1_hr.place(x=650, y=0, width=55, height=25)

        self.lb3_hr = Label(self.fm3, text='05', font=('times new roman', 20, 'bold'), bg='black', fg='white')
        self.lb3_hr.place(x=710, y=0, width=55, height=25)

        self.lb5_hr = Label(self.fm3, text='37', font=('times new roman', 20, 'bold'), bg='black', fg='white')
        self.lb5_hr.place(x=770, y=0, width=55, height=25)

        self.lb7_hr = Label(self.fm3, text='AM', font=('times new roman', 17, 'bold'), bg='black', fg='white')
        self.lb7_hr.place(x=830, y=0, width=55, height=25)
        ...
        self.develop = Label(self.fm3, text='Developed By - AKHILESH ,PRASHANT & PRAVEEN', bg='#fff', fg='orange',
                             font=('Cursive', 10, 'italic', 'bold'))
        self.develop.place(x=500, y=350)
